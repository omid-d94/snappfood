        ...
        <div class="mx-auto bg-gray-50 shadow-xl justify-center items-center w-1/2 mt-20 p-20">
            ...
            <div class="mb-4">
                ...
                <input class="rounded-2xl border-2 border-blue-200 hover:border-blue-300 p-2 w-full"
                       ...
                       name="title" id="title" placeholder="Write Here ... " required>
            ...
            <div class="mb-4">
                ...
                <select class="rounded-2xl border-2 border-blue-200 hover:border-blue-300 p-2 w-full"
                        name="percent" id="percent" required>
                    <option value="{{$discount->percent}}" selected>{{$discount->percent}}%</option>
                    @for($i=10;$i<100;$i+=10)
            ...
            <div class="mb-4">
                ...
                <input class="rounded-2xl border-2 border-blue-200 hover:border-blue-300 p-2 w-full"
                       type="datetime-local" name="expired_at" id="expired_at" required
