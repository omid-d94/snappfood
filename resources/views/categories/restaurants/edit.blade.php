<x-app-layout>
    <div class="m-6 mx-auto shadow-lg p-5 container">
        ...
        <form method="POST" action="{{url("/restaurants/{$category->id}")}}" enctype="multipart/form-data">
            @csrf
            @method("PUT")
            ...
            <div class="text-center">
                <button type="submit"
                        class="hover:bg-green-500 px-16 font-bold text-xl
                        py-3 bg-green-600 text-white rounded-2xl">
                    Save
                </button>
            </div>
        </form>
