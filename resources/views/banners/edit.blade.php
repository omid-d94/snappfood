<x-admin-app-layout>
    ...
    <div class="mx-auto m-10 p-5 flex justify-between">
        <div class="w-1/3">
        ...
        <div class="w-full">
            <form action="{{route("banners.update",$banner->id)}}"
                ...
                @csrf
                @method("PUT")
                <div class="justify-center items-center mx-auto text-center">
                    <button type="submit"
                            class="font-bold text-2xl text-green-700 text-center hover:text-blue-600 px-10 py-5
